(function() {
  ...
  //use indexof === -1, to check it doesn't exist.
  _.uniq = function(array, isSorted, iterator) {
    // var unique = {}, results = [];
    // if(iterator){
    //   _.filter(array, function(val, key, collection){
  ...
  _.delay = function(func, wait) {
    return arguments > 2 ? setTimeout(func.bind(arguments), wait) : setTimeout(func.bind(), wait);
  };
